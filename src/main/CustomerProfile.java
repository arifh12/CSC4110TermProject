...
public class CustomerProfile {
    ...
    public CustomerProfile(String id, String name, String staddress, String city, String state,
                           String phone, String balance, String lastpaidamount, String lastorderdate) {
